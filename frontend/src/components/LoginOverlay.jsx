    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-blue-100 p-8 rounded-2xl shadow-lg w-96 relative">
                <button
                    className="absolute top-6 right-6 bg-red-600 text-red-50 "
                    onClick={onClose}>
                    ✕
                </button>
                ...
                <p className="text-center text-sm text-pri mt-4">
                    Don't have an account? <span className="text-yellow font-semibold cursor-pointer hover:underline">REGISTER NOW</span>
                </p>
            </div>
        </div>
    );
