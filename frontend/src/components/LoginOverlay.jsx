...
const LoginOverlay = ({ onClose }) => {
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 p-4">
            <div className="bg-blue-100 p-6 sm:p-8 rounded-2xl shadow-lg w-full max-w-md relative">
                <button
                    className="absolute top-4 right-4 bg-red-700 text-red-50 p-2 rounded-full hover:bg-red-800"
                    onClick={onClose}
                >
                    ✕
                </button>
                ...
                <input
                    type="text"
                    className="w-full p-2 mb-2 bg-gray-50 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
