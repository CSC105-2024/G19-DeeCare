  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <div className="">
              ...
              <button type="submit" className="p-2 ml-4 mt-5 bg-blue-400 rounded-full"><img src="icons/SearchIcon.png" className='rounded-full h-5 w-5 object-cover'></img></button>
              <Link to="/FilterBar">
              <button className="p-2 ml-4 bg-blue-400 rounded-full"><img src="icons/FilterIcon.jpg" className='rounded-full h-5 w-5 object-cover'></img></button>
              </Link>
              </div>
      </div>
