        ...
        <>
            <div className="bg-gradient-to-t from-blue-300 to-white">
                <div className="hidden md:block">
                    <button>
                        <Link to="/FilterBar"> <img src="icons/Back.png"
                                                    className='fixed mx-15 my-15 lg:35 xl:mx-50 bottom-1 left-1 rounded-4xl h-15 w-15 object-cover bg-white'></img>
                        </Link>
                    </button>
                </div>
                ...
                <div className="max-w-150 mt-15 container object-center justify-self-center ">
                  ...
                  h-9  ">
                                ...
                                <div className="flex flex-row justify-end">
                                    <button type="submit"
                                            className="justify-items-center bg-pri hover:bg-blue-700 duration-300 py-2 w-9">
                                        <img src="icons/search.png" className=' h-5 w-5 object-cover'></img></button>
                                    <Link to="/FilterBar">
                                        <button className="p-2 object-left bg-pri  hover:bg-blue-700 duration-300"><img
                                            src="icons/filter.png" className=' h-5 w-5 object-cover'></img></button>
                                    </Link>
                                </div>
                            </form>
                            ...
                            >
                                ...
                                {selectedDoctor === doctor.id && (
                                    <div className="p-4 text-sm">
                                        <div className="text-gray-700 ml-2">Specialization
