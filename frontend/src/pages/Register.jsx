...
function Register() {
    ...
    const handleSubmit = (e) => {
        ...
        console.log("Form submitted and saved:", form);
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div className={currentStep === 1 ? "block" : "hidden"}>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            placeholder="ENTER ANY CHRONIC DISEASES (OR '-' IF NONE)"
                            className="w-full p-3 rounded-md bg-gray-50 border border-blue-100 placeholder-gray-500"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            placeholder="ENTER ANY DRUG ALLERGIES (OR '-' IF NONE)"
                            className="w-full p-3 rounded-md bg-gray-50 border border-blue-100 placeholder-gray-500"
                        />
                    </div>
                ...
                <div className="flex flex-row justify-between mt-6">
                    ...
                    {currentStep < 2 ? (
                        <button
                            type="button"
                            className="px-6 py-2 bg-pri text-white rounded-md hover:bg-blue-700"
                            onClick={() => setCurrentStep(prev => prev + 1)}
                        >
                            Next
                        </button>
