...
function Register() {
    ...
    return (<div className="flex justify-center items-center min-h-screen bg-white mt-24 p-4">
        <div className="bg-blue-100 p-8 rounded-xl shadow-md max-w-3xl w-full">
            ...
            <div className="flex items-center justify-center mb-8">
                <div className="flex flex-row justify-center items-center gap-4 relative z-10 w-fit">
                    <div className="bg-blue-900 w-full h-1 absolute top-[35%] rounded -z-10"></div>
                    {stepTitle.map((title, index) => (
                        <div key={index + 1} className="flex flex-col items-center justify-center relative">
                            <div className={cn(
                                ...
                                currentStep >= index + 1 ? "bg-blue-900" : "bg-gray-500"
                            )}>
                                {index + 1}
                            </div>
                            <span className={cn(
                                "font-medium text-sm",
                                currentStep >= index + 1 ? "text-blue-900 font-semibold" : null,
                            )}>{title}</span>
                        </div>
                    ))}
                </div>
