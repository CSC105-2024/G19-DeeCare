...
const Admin_Appointment = () => {
  return (
    <form action="/Admin_post" className="justify-center flex flex-col lg:flex-row ">
      <div>
        <h2 className="px-7 mt-5 text-2xl text-blue-950">Doctor Information</h2>
        <div className="bg-light-blue p-5 w-119 h-110 mx-5 rounded-2xl ">
          <div className="mx-2 my-2">
            <div className="text-pri ml-1">Doctor ID</div>
            <input type="text"
            placeholder="Type Doctor id"
            maxLength={13} 
            className="bg-white p-2 px-4 rounded-lg w-105 outline-0" 
            pattern="[0-9]{13}"
          ...
          <div className="mx-2 my-2">
            ...
            <textarea rows={2}className="bg-white p-2 px-4 rounded-lg w-105  outline-0"  
            placeholder="Type Address of Appointment place" name="address"></textarea>
          </div>
          <div className="mx-2 my-2">
            <div className="text-pri ml-1">Appoinment Details</div>
            <textarea rows={4}className="bg-white p-2 px-4 rounded-lg w-105  outline-0"  
      ...
      <div>
        ...
        <div className="bg-light-blue p-5 w-119 h-110 mx-5 mb-5 rounded-2xl ">
          <div className="mx-2 my-2">
          ...
          <div className="flex flex-row">
            <div className="mx-2 my-2">
              ...
              className="bg-white p-2 px-4 rounded-lg w-55  outline-0" />
            </div>
            <div className="mx-2 my-2">
              <div className="text-pri ml-1">Time</div>
              <input type="Time" placeholder="MM/DD/YYYY"
              className="bg-white p-2 px-4 rounded-lg w-46  outline-0" />
            </div>
          </div>
          <div className="mx-2 my-2">
            <div className="text-pri ml-1">Notification Messaages</div> 
            <textarea rows={3}className="bg-white p-2 px-4 rounded-lg w-105 outline-0"  
            placeholder="Type Address of Appointment place" name="address"></textarea>
          </div>
          <div>
